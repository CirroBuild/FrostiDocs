...
As an Senior Backend Engineer, you will be a critical part of our growing company,
contributing towards the launch of a greenfield cloud-hosted database as a service
(DBaaS) solution. You will bring your expertise to build a Python-based backend for
the QuestDB DBaaS offering in close collaboration with the cloud engineering team.
