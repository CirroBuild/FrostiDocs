...
<Banner alt="Rasppberry Pi devices on a workbench used in an IoT project" height={433} src="/img/tutorial/2021-02-05/banner.jpg" width={650}>
Photo by{" "}
  <a href="https://unsplash.com/@_louisreed">Louis Reed
</a>{" "}
...
Influx line protocol compatibility. The [live demo](http://try.questdb.io:9000/)
on the website queries the NYC taxi rides dataset with over 1.6 billion rows in
milliseconds, so I was excited to give this database a try. To round out the
end-to-end demo, I used Grafana to pull and visualize data from QuestDB.
