...
<Banner
  ...
  width={650}
>
  Photo by <a href="https://unsplash.com/photos/ztYmIQecyH4">Tech Daily</a> via{" "}
...
[submit a PR](https://github.com/questdb/questdb-slack-grafana-alerts) if you have
a suggestion or improvements to make!
