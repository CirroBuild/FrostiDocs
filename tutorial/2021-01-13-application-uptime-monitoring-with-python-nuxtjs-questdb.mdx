...
This submission comes from one of our community contributors [Gábor Boros](https://github.com/gabor-boros) who has
built an extremely robust statuspage application which uses QuestDB as a data
sink.
...
[Postgres compatibility](https://questdb.io/docs/develop/connect), you can use
