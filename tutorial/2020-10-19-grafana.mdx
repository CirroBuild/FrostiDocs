...
<Banner alt="A dashboard showing several graphs with operationnal data" height={433} src="/img/tutorial/2020-10-19/banner.jpg" width={650}>
  Photo by <a href="https://unsplash.com/photos/JKUTrJ4vK00">Luke Chesser</a> via <a href="https://unsplash.com">Unsplash</a>
</Banner>
...
On our [live demo]({@demoUrl@}), uses 10+ years of taxi data.
