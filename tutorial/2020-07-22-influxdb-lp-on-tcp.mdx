...
description:
  ...
  with QuestDB.
image: /img/tutorial/2020-07-22/banner.jpg
featured: true
---
...
>
  Photo by{" "}
  <a href="https://unsplash.com/photos/z0l-3cWpKto"> Ricardo Gomez Angel </a> via{" "}
...
Using and configuring it are relatively simple, so this tutorial will walk
you through the basics of setting it up and using it. For an added bonus, we'll
see how to migrate from using InfluxDB to using QuestDB with a single-line
...
about them in our [docs](/docs/reference/api/influxdb/). I hope they are
...
As I initially mentioned, I'm now going to give you a simple, less-than-one-line
configuration change to migrate from using InfluxDB to using QuestDB. If you're
using Telegraf as a data collector, that is.
