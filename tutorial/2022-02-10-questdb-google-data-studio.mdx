...
keywords:
  ...
  - cryptocurrency
  - benchmark
image: /img/tutorial/shared/og-google-data-studio.png
...
QuestDB provides an [official Helm chart](/docs/guides/kubernetes/) that deploys
...
[IPs that Dats Studio uses](https://support.google.com/datastudio/answer/7288010?hl=en#zippy=%2Cin-this-article)
